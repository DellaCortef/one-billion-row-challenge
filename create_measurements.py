...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    try:
        with open("./data/measurements2M.txt", 'w', encoding="utf-8") as file:
    ...
    file_size = os.path.getsize("./data/measurements2M.txt")
    human_file_size = convert_bytes(file_size)
 
    print("Arquivo escrito com sucesso data/measurements2M.txt")
